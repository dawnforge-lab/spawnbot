 ...
 *
 * Pure functions that take botToken as a parameter — used by both the daemon
 * (for auto-response routing, typing indicators) and the MCP server (for
 * proactive messaging, photo/voice/document sending).
 */
 ...
 * @param {string} text - Message text (markdown formatted — auto-converted to Telegram HTML)
